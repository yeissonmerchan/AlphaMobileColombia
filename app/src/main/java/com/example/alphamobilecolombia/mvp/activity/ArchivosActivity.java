...
public class ArchivosActivity extends AppCompatActivity {
    ...
    public List<com.example.alphamobilecolombia.utils.models.File> getListFiles(){
        ...
        filesRequired.add(new com.example.alphamobilecolombia.utils.models.File(72,"",false,"Desprendible3",false));
        filesRequired.add(new com.example.alphamobilecolombia.utils.models.File(73,"",false,"Desprendible4",false));
