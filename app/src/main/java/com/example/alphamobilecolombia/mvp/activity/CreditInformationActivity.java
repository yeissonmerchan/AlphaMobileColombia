...
public class CreditInformationActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
...
/*        setContentView(R.layout.activity_credit_information);
        ...
        new IntentIntegrator(CreditInformationActivity.this)
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(result != null) {
            if(result.getContents() == null) {
                Log.d("CreditInformation", "Scaneo cancelado");
